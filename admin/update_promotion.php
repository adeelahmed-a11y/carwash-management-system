...
<div class="card">
<div class="card-body">
<h5 class="pb-5">Update Promotion</h5>
<form method="post">
...
if(isset($_POST['submit'])){
	...
	$sql="update promotion set title='$title', description='$description' where id='$id'";
	$result=mysqli_query($con,$sql);
	if($result){
		echo '<script>swal("Successfully", "Promotion updated successfully", "success").then(function() { window.location = "promotion.php";  });</script>';
	}
	else{
